...
var BufferController = function (_Event) {
    ...
    function BufferController(sourceBuffer, type) {
        ...
        _this.sourceBuffer.addEventListener('update', function () {
            if (_this.queue && _this.queue.length > 0 && !_this.sourceBuffer.updating) _this.sourceBuffer.appendBuffer(_this.queue.shift());
        });
